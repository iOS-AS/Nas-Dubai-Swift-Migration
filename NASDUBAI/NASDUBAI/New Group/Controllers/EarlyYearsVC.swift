...
class EarlyYearsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.getDepartmentEarlyListData()
    ...
    */
    ...
    func setUpUI() {
        BannerImage.sd_setImage(with: URL(string: imageURLString), placeholderImage: #imageLiteral(resourceName: "homePageSampleBanner.png"))
    ...
    @IBAction func revealPress(_ sender: UIButton) {
    }
...
extension EarlyYearsVC: UITableViewDelegate, UITableViewDataSource {
...
//MARK: - API Call
extension EarlyYearsVC {
    func getDepartmentEarlyListData() {
        ApiServices().getDepartmentEarlyListFromAPI() { responseData in
